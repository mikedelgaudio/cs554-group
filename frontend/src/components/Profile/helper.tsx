...
// Change First Name
export const changeFirstName = async (currentUser: any, newFirstName: string) => {
    try {
        if (currentUser) {
            await postRequest(
                `http://localhost:3001/users/${currentUser.uid}/editUser`,
...
export const changeProfilePicture = async (currentUser: any, newProfilePicture: string) => {
    try {
        if (currentUser) {
            await postRequest(
                `http://localhost:3001/users/${currentUser.uid}/editUser`,
...
// Change Occupation
export const changeOccupation = async (currentUser: any, newOccupation: string) => {
    const user = await axios.get(`http://localhost:3001/users/profile/${currentUser.uid}`);
...
// Add Social Media
export const addSocialMedia = async (currentUser: any, socialMediaURL: string) => {
    const user = await axios.get(`http://localhost:3001/users/profile/${currentUser.uid}`);
...
export const addFavoritedUser = async (currentUser: any, favoritedUserID: any) => {
    const user = await axios.get(`http://localhost:3001/users/profile/${currentUser.uid}`);
...
export const deleteFavoritedUser = async (currentUser: any, favoritedUserID: any) => {
    const user = await axios.get(`http://localhost:3001/users/profile/${currentUser.uid}`);
